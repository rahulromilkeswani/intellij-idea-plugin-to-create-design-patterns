...
public class Template extends JDialog {
    ...
    private void onOK() {
        templateAction.setAbstractClass(abstractClass.getText());
        templateAction.setConcreteClass(concreteClass.getText());
        templateAction.setMethodName(methodName.getText());
        dispose();
    }
